...
void	printSet(set set, InputIt it, std::string type) {
...
int	main(void) {
	ft::set<int, std::string>						m1;
	ft::set<int, std::string>::iterator				it1;
	ft::set<int, std::string>::reverse_iterator		rit1;
	std::set<int, std::string>						m2;
	std::set<int, std::string>::iterator			it2;
	std::set<int, std::string>::reverse_iterator	rit2;
	...
	// CAPACITY
	{
		...
		ft::set<int, std::string>						m3;
		std::set<int, std::string>						m4;
	...
	// OBSERVERS
	{
		ft::set<int, std::string>::iterator		it3;
		std::set<int, std::string>::iterator	it4;
